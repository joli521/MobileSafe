...
//      getSupportActionBar().hide();  //去掉标题栏,只能去掉单个Acitvity
        ...
        /**< 设置viewPager监听器：主要是计算红点的移动距离，做到更好的用户体验 */
        mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            //主要获得图片移动的距离
            @Override
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                LogUtil.e(ConstantUtil.TAG, "移动的百分比="+positionOffset);
                // 更新小红点距离**********不懂************************************
//                int leftMargin = (int) (mPointDis * positionOffset) + position* mPointDis;// 计算小红点当前的左边距
            ...
            public void onPageSelected(int position) {
                LogUtil.e(ConstantUtil.TAG, "mViewPager的位置==="+position);
        ...
        mRedImgView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                LogUtil.e(ConstantUtil.TAG, "小红点移动的距离==="+mPointDis);
            }
        });

        /**< 最后一页显示开始体验按钮，且保存登录状态 */
...
//                startActivity(intent);
    ...
    /**
     * @func:1.向Viewpage中添加图片 2.添加三个空白点
     */
